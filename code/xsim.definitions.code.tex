...
\DeclareExerciseTranslations {default-heading} {
  ...
  Dutch    = \XSIMmixedcase { \GetExerciseParameter {solution-name} en }~
             op~ de~ \XSIMmixedcase { \GetExerciseParameter {exercise-name} en} ,
...
\DeclareExerciseTranslations {collection-heading} {
  ...
  Dutch    = \XSIMmixedcase { \GetExerciseParameter {exercise-name} en } ,
